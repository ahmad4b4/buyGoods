...
function getDefault(){
	...
	$run_c = mysqli_query($con,$get_c);
	 ...
	 $row_c = mysqli_fetch_array($run_c);
		...
		$get_orders = "select * from orders where user_id = '$customer_id' AND order_status='Pending'";
			...
			if($count_orders>0){
				...
				echo "
						...
						<h1 style='color:red'>Hello $customer_name !</h1>
						<h2>You have $count_orders Pending order(s)</h2>
						<h3>Please see your orders details by clicking this link  <a href='my_account.php?my_order'>Order Details</a></h3> 
				...
				";
					...
					echo "
						...
						<h3>You can see your orders history details by clicking this link <a href='my_account.php?my_order'>Order Details</a></h3>
						</div>";
